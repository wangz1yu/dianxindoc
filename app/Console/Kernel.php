...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('notification:sendEmail')->everyTenMinutes();
        $schedule->command('notification:deleteArchiveDocuments')->daily();
        $schedule->command('notification:deleteOrArchiveDocument')->daily();
        $schedule->command('notification:deleteLogs')->daily();
    }
